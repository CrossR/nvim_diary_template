...
class issue_helpersTest(unittest.TestCase):
	...
	def test_insert_edit_tag(self):
		raise NotImplementedError() #TODO: test insert_edit_tag
	...
	def test_sort_completion_state(self):
		raise NotImplementedError() #TODO: test sort_completion_state

	def test_get_github_objects(self):
